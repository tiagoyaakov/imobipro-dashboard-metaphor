...
export default function RegisterPage() {
  return (
    <PageTemplate
      title="Registrar - ImobiPRO Dashboard"
      description="Crie sua conta para acessar o sistema de gestão imobiliária profissional"
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Preencha os dados para começar a usar o ImobiPRO
            </p>
          </div>
        </div>
        ...
        <Card className="shadow-xl border-border/50">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Complete o formulário para criar sua conta
            </CardDescription>
          </CardHeader>
          <CardContent>
            <SignUp 
